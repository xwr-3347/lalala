...
from dataloader import polyvore_dataset, DataGenerator
...
if __name__=='__main__':
    ...
    model.save('/Users/xuwenrui/Developer/541/HW5/tensor/mobilenet-model.hdf5')
    ...
    plt.legend()
    plt.savefig('/Users/xuwenrui/Developer/541/HW5/tensor/mobilenet_loss.png', dpi=256)
    plt.close()
    ...
    plt.legend()
    plt.savefig('/Users/xuwenrui/Developer/541/HW5/tensor/mobilenet_acc.png', dpi=256)
    plt.close()
