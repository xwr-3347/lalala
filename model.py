...
def my_model(width, height, depth, classes):
    ...
    model.add(Dense(512, kernel_regularizer=regularizers.l2(
        Config['reg_value']), bias_regularizer=regularizers.l2(Config['reg_value'])))
    model.add(Activation("relu"))
    model.add(BatchNormalization())
    model.add(Dropout(0.5))

    # softmax classifier
    model.add(Dense(classes, kernel_regularizer=regularizers.l2(
        Config['reg_value']), bias_regularizer=regularizers.l2(Config['reg_value'])))
...
if __name__ == '__main__':
    ...
    model.compile(optimizer=optimizers.RMSprop(
        lr=Config['learning_rate']), loss='categorical_crossentropy', metrics=['accuracy'])
    model.summary()
    plot_model(model, to_file='category_model.png',
    ...
    model.save('/Users/xuwenrui/Developer/541/HW5/tensor/category_model.hdf5')
    ...
    plt.legend()
    plt.savefig('/Users/xuwenrui/Developer/541/HW5/tensor/category_model_loss.png', dpi=256)
    plt.close()
    ...
    plt.legend()
    plt.savefig('/Users/xuwenrui/Developer/541/HW5/tensor/category_model_acc.png', dpi=256)
    plt.close()
